...
Second, overall-label analyses are constrained by the fact that all 14 expert overall labels in this study are serious, which limits the interpretability of overall-label agreement measures. For that reason, the primary endpoint in this study focuses on criterion-level agreement in Conditions B–D rather than on overall-label agreement alone.
