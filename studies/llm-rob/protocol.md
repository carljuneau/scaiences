...
In this pilot study, we aim to compare the accuracy of two LLMs (weak and strong) against expert gold-standard RoB labels from earlier epidemiological work during the Covid-19 pandemic (Juneau et al., 2023).
